...
class CRUDGeneratorService {
    ...
    showScheema(scheema) {
      ...
      for (var relId in schemaRelations) {
        ...
        var firstTableColumn = schemaRelations[relId].firstTableColumn;
        console.log(
            firstTable +
            " -- " +
            relationType +
    ...
    validateScheema(scheema) {
      ...
      var columnsScheema = {
        ...
        "properties": {
          ...
          "type": { 
            "enum": [
              "text","number","email","password","date", "double"
            ]
          },
      ...
      var relationsSchema = {
        ...
        "properties": {
          ...
          "firstTableColumn": {"type": "string"}
        },
        "required": ["firstTable","secondTable","relationType","secondTableColumn","firstTableColumn"]
      };
