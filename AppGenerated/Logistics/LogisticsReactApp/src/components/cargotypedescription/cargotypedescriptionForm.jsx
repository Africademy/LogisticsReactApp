...
import { saveCargotypedescription, getCargotypedescription } from "../../services/cargotypedescriptionService";

class createCargotypedescription extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveCargotypedescription(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Cargotypedescription Form</h1>
...
export default createCargotypedescription;