...
import { saveIncludedtransportmeans, getIncludedtransportmeans } from "../../services/includedtransportmeansService";

class createIncludedtransportmeans extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(includedtransportmeansId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveIncludedtransportmeans(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Includedtransportmeans Form</h1>
...
export default createIncludedtransportmeans;