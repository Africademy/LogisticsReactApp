...
import { saveDeclaredweightforcustoms, getDeclaredweightforcustoms } from "../../services/declaredweightforcustomsService";

class createDeclaredweightforcustoms extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(declaredweightforcustomsId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDeclaredweightforcustoms(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Declaredweightforcustoms Form</h1>
...
export default createDeclaredweightforcustoms;