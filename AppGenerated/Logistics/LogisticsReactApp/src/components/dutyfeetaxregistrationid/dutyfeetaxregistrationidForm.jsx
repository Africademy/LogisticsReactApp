...
import { saveDutyfeetaxregistrationid, getDutyfeetaxregistrationid } from "../../services/dutyfeetaxregistrationidService";

class createDutyfeetaxregistrationid extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(dutyfeetaxregistrationidId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDutyfeetaxregistrationid(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Dutyfeetaxregistrationid Form</h1>
...
export default createDutyfeetaxregistrationid;