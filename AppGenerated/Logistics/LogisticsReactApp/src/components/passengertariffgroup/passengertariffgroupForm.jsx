...
import { savePassengertariffgroup, getPassengertariffgroup } from "../../services/passengertariffgroupService";

class createPassengertariffgroup extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await savePassengertariffgroup(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Passengertariffgroup Form</h1>
...
export default createPassengertariffgroup;