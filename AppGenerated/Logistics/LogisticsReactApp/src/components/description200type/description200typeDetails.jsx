...
import { getDescription200type } from "../../services/description200typeService";

class Description200typeDetails extends Component{
  ...
  render() {
    return (
      <div className="content">
        <h1>Description200type Details</h1>
...
export default Description200typeDetails;