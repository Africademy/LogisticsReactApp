...
import { saveContentowner, getContentowner } from "../../services/contentownerService";

class createContentowner extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveContentowner(this.state.data);
...
export default createContentowner;