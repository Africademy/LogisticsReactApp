...
import { saveContacttypecode, getContacttypecode } from "../../services/contacttypecodeService";

class createContacttypecode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveContacttypecode(this.state.data);
...
export default createContacttypecode;