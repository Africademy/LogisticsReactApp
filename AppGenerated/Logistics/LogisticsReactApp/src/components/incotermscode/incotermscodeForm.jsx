...
import { saveIncotermscode, getIncotermscode } from "../../services/incotermscodeService";

class createIncotermscode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveIncotermscode(this.state.data);
...
export default createIncotermscode;