...
import { saveLogisticeventtypecode, getLogisticeventtypecode } from "../../services/logisticeventtypecodeService";

class createLogisticeventtypecode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(logisticeventtypecodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveLogisticeventtypecode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Logisticeventtypecode Form</h1>
...
export default createLogisticeventtypecode;