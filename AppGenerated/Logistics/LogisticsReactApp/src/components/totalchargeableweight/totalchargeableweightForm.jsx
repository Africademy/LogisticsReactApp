...
import { saveTotalchargeableweight, getTotalchargeableweight } from "../../services/totalchargeableweightService";

class createTotalchargeableweight extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(totalchargeableweightId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTotalchargeableweight(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Totalchargeableweight Form</h1>
...
export default createTotalchargeableweight;