...
import { saveAdditionallocationidentification, getAdditionallocationidentification } from "../../services/additionallocationidentificationService";

class createAdditionallocationidentification extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(additionallocationidentificationId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveAdditionallocationidentification(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Additionallocationidentification Form</h1>
...
export default createAdditionallocationidentification;