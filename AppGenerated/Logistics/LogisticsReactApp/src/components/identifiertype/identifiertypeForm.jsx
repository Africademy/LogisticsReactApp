...
import { saveIdentifiertype, getIdentifiertype } from "../../services/identifiertypeService";

class createIdentifiertype extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveIdentifiertype(this.state.data);
...
export default createIdentifiertype;