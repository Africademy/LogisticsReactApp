...
import { saveTotalitemquantity, getTotalitemquantity } from "../../services/totalitemquantityService";

class createTotalitemquantity extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTotalitemquantity(this.state.data);
...
export default createTotalitemquantity;