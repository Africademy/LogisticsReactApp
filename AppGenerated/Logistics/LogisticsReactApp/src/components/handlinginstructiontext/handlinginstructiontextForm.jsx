...
import { saveHandlinginstructiontext, getHandlinginstructiontext } from "../../services/handlinginstructiontextService";

class createHandlinginstructiontext extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(handlinginstructiontextId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveHandlinginstructiontext(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Handlinginstructiontext Form</h1>
...
export default createHandlinginstructiontext;