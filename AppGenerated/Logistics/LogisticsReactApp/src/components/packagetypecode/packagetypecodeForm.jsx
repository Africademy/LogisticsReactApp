...
import { savePackagetypecode, getPackagetypecode } from "../../services/packagetypecodeService";

class createPackagetypecode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await savePackagetypecode(this.state.data);
...
export default createPackagetypecode;