...
import { saveCargotypecode, getCargotypecode } from "../../services/cargotypecodeService";

class createCargotypecode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveCargotypecode(this.state.data);
...
export default createCargotypecode;