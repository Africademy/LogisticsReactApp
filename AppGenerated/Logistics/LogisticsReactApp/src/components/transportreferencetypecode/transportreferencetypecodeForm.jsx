...
import { saveTransportreferencetypecode, getTransportreferencetypecode } from "../../services/transportreferencetypecodeService";

class createTransportreferencetypecode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(transportreferencetypecodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportreferencetypecode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportreferencetypecode Form</h1>
...
export default createTransportreferencetypecode;