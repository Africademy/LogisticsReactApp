...
import { saveNewholderregistration, getNewholderregistration } from "../../services/newholderregistrationService";

class createNewholderregistration extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(newholderregistrationId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveNewholderregistration(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Newholderregistration Form</h1>
...
export default createNewholderregistration;