...
import { saveReturnablepackaging, getReturnablepackaging } from "../../services/returnablepackagingService";

class createReturnablepackaging extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveReturnablepackaging(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Returnablepackaging Form</h1>
...
export default createReturnablepackaging;