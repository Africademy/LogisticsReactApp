...
import { saveLegalregistrationtype, getLegalregistrationtype } from "../../services/legalregistrationtypeService";

class createLegalregistrationtype extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(legalregistrationtypeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveLegalregistrationtype(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Legalregistrationtype Form</h1>
...
export default createLegalregistrationtype;