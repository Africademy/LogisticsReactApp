...
import { saveDutyfeetaxtypecode, getDutyfeetaxtypecode } from "../../services/dutyfeetaxtypecodeService";

class createDutyfeetaxtypecode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDutyfeetaxtypecode(this.state.data);
...
export default createDutyfeetaxtypecode;