...
import { getTransportmeansid } from "../../services/transportmeansidService";

class TransportmeansidDetails extends Component{
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportmeansid Details</h1>
...
export default TransportmeansidDetails;