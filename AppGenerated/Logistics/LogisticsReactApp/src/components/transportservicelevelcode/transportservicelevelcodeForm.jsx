...
import { saveTransportservicelevelcode, getTransportservicelevelcode } from "../../services/transportservicelevelcodeService";

class createTransportservicelevelcode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(transportservicelevelcodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportservicelevelcode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportservicelevelcode Form</h1>
...
export default createTransportservicelevelcode;