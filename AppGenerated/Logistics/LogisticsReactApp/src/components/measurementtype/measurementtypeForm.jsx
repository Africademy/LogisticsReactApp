...
import { saveMeasurementtype, getMeasurementtype } from "../../services/measurementtypeService";

class createMeasurementtype extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveMeasurementtype(this.state.data);
