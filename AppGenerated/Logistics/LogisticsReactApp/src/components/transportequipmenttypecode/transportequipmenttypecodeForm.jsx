...
import { saveTransportequipmenttypecode, getTransportequipmenttypecode } from "../../services/transportequipmenttypecodeService";

class createTransportequipmenttypecode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(transportequipmenttypecodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportequipmenttypecode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportequipmenttypecode Form</h1>
...
export default createTransportequipmenttypecode;