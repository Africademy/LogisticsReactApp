...
import { saveDropoffparty, getDropoffparty } from "../../services/dropoffpartyService";

class createDropoffparty extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDropoffparty(this.state.data);
...
export default createDropoffparty;