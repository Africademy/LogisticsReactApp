...
class createTransportcapacitybookingold extends Component {
  constructor(props) {
    super(props);
    this.populatetransportCapacityBookingSpaceRequirementss = this.populatetransportCapacityBookingSpaceRequirementss.bind(
      this
    );
    this.populatetransportCapacityBookingTransportMovements = this.populatetransportCapacityBookingTransportMovements.bind(
      this
    );
    this.populateavpLists = this.populateavpLists.bind(this);
    this.populatedocumentStatusCodes = this.populatedocumentStatusCodes.bind(
      this
    );
    ...
    this.populatetransportReferences = this.populatetransportReferences.bind(
      this
    );
    this.populatehandlingInstructions = this.populatehandlingInstructions.bind(
      this
    );
    this.populatedocumentActionCodes = this.populatedocumentActionCodes.bind(
      this
    );
    this.populatetransportCapacityBookingIdentifications = this.populatetransportCapacityBookingIdentifications.bind(
      this
    );
    this.populatetransportServiceCategoryCodes = this.populatetransportServiceCategoryCodes.bind(
      this
    );
    this.populatetransportServiceConditionTypeCodes = this.populatetransportServiceConditionTypeCodes.bind(
      this
    );
    this.populatetransportServiceLevelCodes = this.populatetransportServiceLevelCodes.bind(
      this
    );
    this.populatelogisticServicesBuyers = this.populatelogisticServicesBuyers.bind(
      this
    );
    this.populatelogisticServicesSellers = this.populatelogisticServicesSellers.bind(
      this
    );
  ...
  state = {
    data: {
      ...
      transportCapacityBookingSpaceRequirementsId: "",
      transportCapacityBookingTransportMovementId: "",
      avpListId: "",
      documentStatusCodeId: "",
      dropOffPartyId: "",
      plannedPickUpId: "",
      plannedDropOffId: "",
      transportReferenceId: "",
      handlingInstructionId: "",
      documentActionCodeId: "",
      transportCapacityBookingIdentificationId: "",
      transportServiceCategoryCodeId: "",
      transportServiceConditionTypeCodeId: "",
      transportServiceLevelCodeId: "",
      logisticServicesBuyerId: "",
      logisticServicesSellerId: "",
      pickUpPartyId: "",
      deliveryTermsId: "",
    },
  ...
  scheema = {
    ...
    creationDateTime: Joi.date().required().label("creationDateTime"),

    documentStatusCode: Joi.number().required().label("documentStatusCode"),

    documentActionCode: Joi.number().label("documentActionCode"),
    ...
    avpListId: Joi.string().required().label("avpListId"),
    documentStatusCodeId: Joi.string().required().label("documentStatusCodeId"),
    dropOffPartyId: Joi.string().required().label("dropOffPartyId"),
    plannedPickUpId: Joi.string().required().label("plannedPickUpId"),
    plannedDropOffId: Joi.string().required().label("plannedDropOffId"),
    transportReferenceId: Joi.string().required().label("transportReferenceId"),
    handlingInstructionId: Joi.string()
      .required()
      .label("handlingInstructionId"),
    documentActionCodeId: Joi.string().required().label("documentActionCodeId"),
    ...
    pickUpPartyId: Joi.string().required().label("pickUpPartyId"),
    deliveryTermsId: Joi.string().required().label("deliveryTermsId"),
    createdAt: Joi.date().label("createAt"),
  };
  ...
  async populateForm() {
    try {
      ...
      if (transportcapacitybookingId !== "new") {
        const { data } = await getTransportcapacitybooking(
          transportcapacitybookingId
        );
        this.setState({ data });
      }
    } catch (ex) {
  ...
  async populatetransportCapacityBookingSpaceRequirementss() {
    const {
      data: transportCapacityBookingSpaceRequirementss,
    } = await getTransportcapacitybookingspacerequirements();
    this.setState({
      transportCapacityBookingSpaceRequirementss: transportCapacityBookingSpaceRequirementss,
    });
  }

  async populatetransportCapacityBookingTransportMovements() {
    const {
      data: transportCapacityBookingTransportMovements,
    } = await getTransportcapacitybookingtransportmovementtypes();
    this.setState({
      transportCapacityBookingTransportMovements: transportCapacityBookingTransportMovements,
    });
  }
  ...
  async populatetransportCapacityBookingIdentifications() {
    const {
      data: transportCapacityBookingIdentifications,
    } = await getEnumerationlibrarys();
    this.setState({
      transportCapacityBookingIdentifications: transportCapacityBookingIdentifications,
    });
  }
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["creationDateTime"] && (
              <div className="alert alert-danger">
                {this.state.errors["creationDateTime"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["documentStatusCode"] && (
              <div className="alert alert-danger">
                {this.state.errors["documentStatusCode"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["documentActionCode"] && (
              <div className="alert alert-danger">
                {this.state.errors["documentActionCode"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="documentStructureVersion">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["documentStructureVersion"] && (
              <div className="alert alert-danger">
                {this.state.errors["documentStructureVersion"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["lastUpdateDateTime"] && (
              <div className="alert alert-danger">
                {this.state.errors["lastUpdateDateTime"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["revisionNumber"] && (
              <div className="alert alert-danger">
                {this.state.errors["revisionNumber"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="documentEffectiveDate">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["documentEffectiveDate"] && (
              <div className="alert alert-danger">
                {this.state.errors["documentEffectiveDate"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportCapacityBookingIdentification">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["transportCapacityBookingIdentification"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportCapacityBookingIdentification"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportServiceCategoryCode">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["transportServiceCategoryCode"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportServiceCategoryCode"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportServiceConditionTypeCode">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["transportServiceConditionTypeCode"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportServiceConditionTypeCode"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportServiceLevelCode">
          ...
          <div className="form-group">
            <label htmlFor="logisticServicesBuyer">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["logisticServicesBuyer"] && (
              <div className="alert alert-danger">
                {this.state.errors["logisticServicesBuyer"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="logisticServicesSeller">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["logisticServicesSeller"] && (
              <div className="alert alert-danger">
                {this.state.errors["logisticServicesSeller"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["dropOffParty"] && (
              <div className="alert alert-danger">
                {this.state.errors["dropOffParty"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["plannedPickUp"] && (
              <div className="alert alert-danger">
                {this.state.errors["plannedPickUp"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["plannedDropOff"] && (
              <div className="alert alert-danger">
                {this.state.errors["plannedDropOff"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["transportReference"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportReference"]}
              </div>
            )}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["handlingInstruction"] && (
              <div className="alert alert-danger">
                {this.state.errors["handlingInstruction"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportCapacityBookingSpaceRequirements">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["transportCapacityBookingSpaceRequirements"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportCapacityBookingSpaceRequirements"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportCapacityBookingTransportMovement">
            ...
            <input
              ...
              className="form-control"
            />
            {this.state.errors["transportCapacityBookingTransportMovement"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportCapacityBookingTransportMovement"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportCapacityBookingSpaceRequirementsId">
              {" "}
              Transport Capacity Booking Space Requirements{" "}
              <a
                target="_blank"
                href="/Transportcapacitybookingspacerequirements/new"
              >
                Add New
              </a>{" "}
              <a
                ...
                onClick={
                  this.populatetransportCapacityBookingSpaceRequirementss
                }
              >
                {" "}
                Refresh
            ...
            <select
              value={
                this.state.data["transportCapacityBookingSpaceRequirementsId"]
              }
              onChange={this.handleChange}
            ...
            >
              ...
              {this.state.transportCapacityBookingSpaceRequirementss.map(
                (Transportcapacitybookingspacerequirement) => (
                  <option
                    key={Transportcapacitybookingspacerequirement._id}
                    value={Transportcapacitybookingspacerequirement._id}
                  >
          ...
          <div className="form-group">
            <label htmlFor="transportCapacityBookingTransportMovementId">
              {" "}
              Transport Capacity Booking Transport Movement{" "}
              <a
                target="_blank"
                href="/Transportcapacitybookingtransportmovementtypes/new"
              >
                Add New
              </a>{" "}
              <a
                href="javascript:void(0)"
                onClick={
                  this.populatetransportCapacityBookingTransportMovements
                }
              >
                {" "}
                Refresh
            ...
            <select
              value={
                this.state.data["transportCapacityBookingTransportMovementId"]
              }
              onChange={this.handleChange}
            ...
            >
              ...
              {this.state.transportCapacityBookingTransportMovements.map(
                (Transportcapacitybookingtransportmovementtype) => (
                  <option
                    key={Transportcapacitybookingtransportmovementtype._id}
                    value={Transportcapacitybookingtransportmovementtype._id}
                  >
          ...
          <div className="form-group">
            <label htmlFor="avpListId">
              {" "}
              Avp List{" "}
              <a target="_blank" href="/Ecomstringattributevaluepairlists/new">
                Add New
              </a>{" "}
              <a href="javascript:void(0)" onClick={this.populateavpLists}>
                {" "}
                Refresh
              </a>{" "}
            </label>
            ...
            >
              ...
              {this.state.avpLists.map((Ecomstringattributevaluepairlist) => (
                <option
                  key={Ecomstringattributevaluepairlist._id}
                  value={Ecomstringattributevaluepairlist._id}
                >
                  {Ecomstringattributevaluepairlist.qualifierCodeName}
                </option>
              ))}
            </select>
            {this.state.errors["avpListId"] && (
              <div className="alert alert-danger">
                {this.state.errors["avpListId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="documentStatusCodeId">
              {" "}
              Document Status Code{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              </a>{" "}
              <a
                href="javascript:void(0)"
                onClick={this.populatedocumentStatusCodes}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            >
              ...
              {this.state.documentStatusCodes.map((Enumerationlibrary) => (
                <option
                  key={Enumerationlibrary._id}
                  value={Enumerationlibrary._id}
                >
                  {Enumerationlibrary.id}
                </option>
              ))}
            </select>
            {this.state.errors["documentStatusCodeId"] && (
              <div className="alert alert-danger">
                {this.state.errors["documentStatusCodeId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="dropOffPartyId">
              {" "}
              Drop Off Party{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              </a>{" "}
              <a href="javascript:void(0)" onClick={this.populatedropOffPartys}>
                {" "}
                Refresh
              </a>{" "}
            </label>
            ...
            {this.state.errors["dropOffPartyId"] && (
              <div className="alert alert-danger">
                {this.state.errors["dropOffPartyId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="plannedPickUpId">
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populateplannedPickUps}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["plannedPickUpId"] && (
              <div className="alert alert-danger">
                {this.state.errors["plannedPickUpId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="plannedDropOffId">
              {" "}
              Planned Drop Off{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populateplannedDropOffs}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["plannedDropOffId"] && (
              <div className="alert alert-danger">
                {this.state.errors["plannedDropOffId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportReferenceId">
              {" "}
              Transport Reference{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatetransportReferences}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["transportReferenceId"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportReferenceId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="handlingInstructionId">
              {" "}
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatehandlingInstructions}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["handlingInstructionId"] && (
              <div className="alert alert-danger">
                {this.state.errors["handlingInstructionId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="documentActionCodeId">
              {" "}
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatedocumentActionCodes}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["documentActionCodeId"] && (
              <div className="alert alert-danger">
                {this.state.errors["documentActionCodeId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportCapacityBookingIdentificationId">
              {" "}
              Transport Capacity Booking Identification{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatetransportCapacityBookingIdentifications}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            <select
              value={
                this.state.data["transportCapacityBookingIdentificationId"]
              }
              onChange={this.handleChange}
            ...
            >
              ...
              {this.state.transportCapacityBookingIdentifications.map(
                (Enumerationlibrary) => (
                  <option
                    key={Enumerationlibrary._id}
                    value={Enumerationlibrary._id}
            ...
            {this.state.errors["transportCapacityBookingIdentificationId"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportCapacityBookingIdentificationId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportServiceCategoryCodeId">
              {" "}
              Transport Service Category Code{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatetransportServiceCategoryCodes}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            >
              ...
              {this.state.transportServiceCategoryCodes.map(
                (Enumerationlibrary) => (
                  <option
                    key={Enumerationlibrary._id}
                    value={Enumerationlibrary._id}
          ...
          <div className="form-group">
            <label htmlFor="transportServiceConditionTypeCodeId">
              {" "}
              Transport Service Condition Type Code{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatetransportServiceConditionTypeCodes}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            >
              ...
              {this.state.transportServiceConditionTypeCodes.map(
                (Enumerationlibrary) => (
                  <option
                    key={Enumerationlibrary._id}
                    value={Enumerationlibrary._id}
            ...
            {this.state.errors["transportServiceConditionTypeCodeId"] && (
              <div className="alert alert-danger">
                {this.state.errors["transportServiceConditionTypeCodeId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="transportServiceLevelCodeId">
              {" "}
              Transport Service Level Code{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatetransportServiceLevelCodes}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            >
              ...
              {this.state.transportServiceLevelCodes.map(
                (Enumerationlibrary) => (
                  <option
                    key={Enumerationlibrary._id}
                    value={Enumerationlibrary._id}
                  >
                    {this.state.errors["transportServiceLevelCodeId"] && (
                      <div className="alert alert-danger">
                        {this.state.errors["transportServiceLevelCodeId"]}
                      </div>
                    )}
          ...
          <div className="form-group">
            <label htmlFor="logisticServicesBuyerId">
              {" "}
              Logistic Services Buyer{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatelogisticServicesBuyers}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["logisticServicesBuyerId"] && (
              <div className="alert alert-danger">
                {this.state.errors["logisticServicesBuyerId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="logisticServicesSellerId">
              {" "}
              Logistic Services Seller{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              ...
              <a
                href="javascript:void(0)"
                onClick={this.populatelogisticServicesSellers}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["logisticServicesSellerId"] && (
              <div className="alert alert-danger">
                {this.state.errors["logisticServicesSellerId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="pickUpPartyId">
              {" "}
              Pick Up Party{" "}
              <a target="_blank" href="/Enumerationlibrarys/new">
                Add New
              </a>{" "}
              <a href="javascript:void(0)" onClick={this.populatepickUpPartys}>
                {" "}
                Refresh
              </a>{" "}
            </label>
            ...
            {this.state.errors["pickUpPartyId"] && (
              <div className="alert alert-danger">
                {this.state.errors["pickUpPartyId"]}
              </div>
            )}
          ...
          <div className="form-group">
            <label htmlFor="deliveryTermsId">
              {" "}
              Delivery Terms{" "}
              <a target="_blank" href="/Incotermscodes/new">
                Add New
              </a>{" "}
              <a
                href="javascript:void(0)"
                onClick={this.populatedeliveryTermss}
              >
                {" "}
                Refresh
              </a>{" "}
            ...
            {this.state.errors["deliveryTermsId"] && (
              <div className="alert alert-danger">
                {this.state.errors["deliveryTermsId"]}
              </div>
            )}
...
export default createTransportcapacitybookingold;
