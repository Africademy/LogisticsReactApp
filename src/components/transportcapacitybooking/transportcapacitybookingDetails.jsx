        ...
        <form onSubmit={this.handleSubmit}>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Id :{this.state.data["bookingId"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Creation Date Time :{this.state.data["createdAt"]}
            </label>
          </div>
          {/* <div className="form-group">
          ...
          <div className="form-group">
            <label className="form-control">
              {" "}
              Pick Up Party :{this.state.data["pickUpParty"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Drop Off Party :{this.state.data["dropOffParty"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Planned Pick Up :{this.state.data["plannedPickUp"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Planned Drop Off :{this.state.data["plannedDropOff"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Transport Reference :{this.state.data["transportReference"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Delivery Terms :{this.state.data["deliveryTerms"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
              {" "}
              Handling Instruction :{this.state.data["handlingInstruction"]}
            </label>
          </div>
          <div className="form-group">
            <label className="form-control">
            ...
            <label className="form-control">
              ...
              {this.state.transportCapacityBookingSpaceRequirementss.map(
                (Transportcapacitybookingspacerequirement) =>
                  this.state.data[
                    "transportCapacityBookingSpaceRequirementsId"
                  ] === Transportcapacitybookingspacerequirement._id
            ...
            <label className="form-control">
              ...
              {this.state.transportCapacityBookingTransportMovements.map(
                (Transportcapacitybookingtransportmovementtype) =>
                  this.state.data[
                    "transportCapacityBookingTransportMovementId"
                  ] === Transportcapacitybookingtransportmovementtype._id
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.avpLists.map((Ecomstringattributevaluepairlist) =>
                this.state.data["avpListId"] ===
                Ecomstringattributevaluepairlist._id
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.documentStatusCodes.map((Enumerationlibrary) =>
                this.state.data["documentStatusCodeId"] ===
                Enumerationlibrary._id
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.dropOffPartys.map((Enumerationlibrary) =>
                this.state.data["dropOffPartyId"] === Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
            </label>
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.plannedPickUps.map((Enumerationlibrary) =>
                this.state.data["plannedPickUpId"] === Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
            </label>
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.plannedDropOffs.map((Enumerationlibrary) =>
                this.state.data["plannedDropOffId"] === Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
            </label>
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.transportReferences.map((Enumerationlibrary) =>
                this.state.data["transportReferenceId"] ===
                Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.handlingInstructions.map((Enumerationlibrary) =>
                this.state.data["handlingInstructionId"] ===
                Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.documentActionCodes.map((Enumerationlibrary) =>
                this.state.data["documentActionCodeId"] ===
                Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.transportServiceCategoryCodes.map(
                (Enumerationlibrary) =>
                  this.state.data["transportServiceCategoryCodeId"] ===
                  Enumerationlibrary._id
                    ? " " + Enumerationlibrary.id
                    : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.transportServiceConditionTypeCodes.map(
                (Enumerationlibrary) =>
                  this.state.data["transportServiceConditionTypeCodeId"] ===
                  Enumerationlibrary._id
                    ? " " + Enumerationlibrary.id
                    : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.transportServiceLevelCodes.map((Enumerationlibrary) =>
                this.state.data["transportServiceLevelCodeId"] ===
                Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.logisticServicesBuyers.map((Enumerationlibrary) =>
                this.state.data["logisticServicesBuyerId"] ===
                Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.logisticServicesSellers.map((Enumerationlibrary) =>
                this.state.data["logisticServicesSellerId"] ===
                Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.pickUpPartys.map((Enumerationlibrary) =>
                this.state.data["pickUpPartyId"] === Enumerationlibrary._id
                  ? " " + Enumerationlibrary.id
                  : ""
              )}{" "}
            </label>
          ...
          <div className="form-group">
            <label className="form-control">
              ...
              {this.state.deliveryTermss.map((Incotermscode) =>
                this.state.data["deliveryTermsId"] === Incotermscode._id
