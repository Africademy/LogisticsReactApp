...
import { saveCommunicationchannelcode, getCommunicationchannelcode } from "../../services/communicationchannelcodeService";

class createCommunicationchannelcode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(communicationchannelcodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveCommunicationchannelcode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Communicationchannelcode Form</h1>
...
export default createCommunicationchannelcode;