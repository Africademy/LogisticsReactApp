...
import { saveTransportmodecode, getTransportmodecode } from "../../services/transportmodecodeService";

class createTransportmodecode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportmodecode(this.state.data);
...
export default createTransportmodecode;