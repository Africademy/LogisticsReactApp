...
import { saveAssociatedinvoiceamount, getAssociatedinvoiceamount } from "../../services/associatedinvoiceamountService";

class createAssociatedinvoiceamount extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(associatedinvoiceamountId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveAssociatedinvoiceamount(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Associatedinvoiceamount Form</h1>
...
export default createAssociatedinvoiceamount;