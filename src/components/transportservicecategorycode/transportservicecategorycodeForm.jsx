...
import { saveTransportservicecategorycode, getTransportservicecategorycode } from "../../services/transportservicecategorycodeService";

class createTransportservicecategorycode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(transportservicecategorycodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportservicecategorycode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportservicecategorycode Form</h1>
...
export default createTransportservicecategorycode;