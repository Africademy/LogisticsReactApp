...
import { saveSpecialdatename, getSpecialdatename } from "../../services/specialdatenameService";

class createSpecialdatename extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveSpecialdatename(this.state.data);
...
export default createSpecialdatename;