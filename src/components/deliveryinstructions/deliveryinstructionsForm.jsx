...
import { saveDeliveryinstructions, getDeliveryinstructions } from "../../services/deliveryinstructionsService";

class createDeliveryinstructions extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDeliveryinstructions(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Deliveryinstructions Form</h1>
...
export default createDeliveryinstructions;