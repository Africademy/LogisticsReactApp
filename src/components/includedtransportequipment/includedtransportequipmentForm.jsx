...
import { saveIncludedtransportequipment, getIncludedtransportequipment } from "../../services/includedtransportequipmentService";

class createIncludedtransportequipment extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(includedtransportequipmentId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveIncludedtransportequipment(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Includedtransportequipment Form</h1>
...
export default createIncludedtransportequipment;