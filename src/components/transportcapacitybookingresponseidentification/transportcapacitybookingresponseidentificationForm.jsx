...
import { saveTransportcapacitybookingresponseidentification, getTransportcapacitybookingresponseidentification } from "../../services/transportcapacitybookingresponseidentificationService";

class createTransportcapacitybookingresponseidentification extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(transportcapacitybookingresponseidentificationId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportcapacitybookingresponseidentification(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportcapacitybookingresponseidentification Form</h1>
...
export default createTransportcapacitybookingresponseidentification;