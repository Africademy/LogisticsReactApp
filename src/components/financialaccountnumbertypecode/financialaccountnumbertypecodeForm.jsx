...
import { saveFinancialaccountnumbertypecode, getFinancialaccountnumbertypecode } from "../../services/financialaccountnumbertypecodeService";

class createFinancialaccountnumbertypecode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(financialaccountnumbertypecodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveFinancialaccountnumbertypecode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Financialaccountnumbertypecode Form</h1>
...
export default createFinancialaccountnumbertypecode;