...
import { saveTab2, getTab2 } from "../../services/tab2Service";

class createTab2 extends Component{
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTab2(this.state.data);
    ...
    return (
      <div className="content">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
              <label htmlFor="varcharcol">Varcharcol</label>
              <input
