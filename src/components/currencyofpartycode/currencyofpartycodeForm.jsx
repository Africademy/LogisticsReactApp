...
import { saveCurrencyofpartycode, getCurrencyofpartycode } from "../../services/currencyofpartycodeService";

class createCurrencyofpartycode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveCurrencyofpartycode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Currencyofpartycode Form</h1>
...
export default createCurrencyofpartycode;