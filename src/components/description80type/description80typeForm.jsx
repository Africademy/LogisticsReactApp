...
import { saveDescription80type, getDescription80type } from "../../services/description80typeService";

class createDescription80type extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDescription80type(this.state.data);
...
export default createDescription80type;