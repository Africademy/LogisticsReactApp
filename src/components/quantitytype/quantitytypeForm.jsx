...
import { saveQuantitytype, getQuantitytype } from "../../services/quantitytypeService";
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveQuantitytype(this.state.data);
...
export default createQuantitytype;