...
import { saveTransportserviceconditiontypecode, getTransportserviceconditiontypecode } from "../../services/transportserviceconditiontypecodeService";

class createTransportserviceconditiontypecode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(transportserviceconditiontypecodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTransportserviceconditiontypecode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Transportserviceconditiontypecode Form</h1>
...
export default createTransportserviceconditiontypecode;