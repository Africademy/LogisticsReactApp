...
import { saveCountryoforigincode, getCountryoforigincode } from "../../services/countryoforigincodeService";

class createCountryoforigincode extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveCountryoforigincode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Countryoforigincode Form</h1>
...
export default createCountryoforigincode;