...
import { savePickupparty, getPickupparty } from "../../services/pickuppartyService";

class createPickupparty extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await savePickupparty(this.state.data);
...
export default createPickupparty;