...
import { saveTotalpackagequantity, getTotalpackagequantity } from "../../services/totalpackagequantityService";

class createTotalpackagequantity extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTotalpackagequantity(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Totalpackagequantity Form</h1>
...
export default createTotalpackagequantity;