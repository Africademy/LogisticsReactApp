...
import { saveDescription70type, getDescription70type } from "../../services/description70typeService";

class createDescription70type extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDescription70type(this.state.data);
...
export default createDescription70type;