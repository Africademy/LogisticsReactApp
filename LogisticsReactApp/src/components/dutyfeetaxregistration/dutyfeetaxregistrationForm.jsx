...
import { saveDutyfeetaxregistration, getDutyfeetaxregistration } from "../../services/dutyfeetaxregistrationService";

class createDutyfeetaxregistration extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(dutyfeetaxregistrationId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDutyfeetaxregistration(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Dutyfeetaxregistration Form</h1>
...
export default createDutyfeetaxregistration;