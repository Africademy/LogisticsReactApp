...
import { saveLegalstructure, getLegalstructure } from "../../services/legalstructureService";

class createLegalstructure extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveLegalstructure(this.state.data);
...
export default createLegalstructure;