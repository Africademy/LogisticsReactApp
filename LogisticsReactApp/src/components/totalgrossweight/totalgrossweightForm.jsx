...
import { saveTotalgrossweight, getTotalgrossweight } from "../../services/totalgrossweightService";

class createTotalgrossweight extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTotalgrossweight(this.state.data);
...
export default createTotalgrossweight;