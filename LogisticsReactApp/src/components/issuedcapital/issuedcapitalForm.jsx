...
import { saveIssuedcapital, getIssuedcapital } from "../../services/issuedcapitalService";

class createIssuedcapital extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveIssuedcapital(this.state.data);
...
export default createIssuedcapital;