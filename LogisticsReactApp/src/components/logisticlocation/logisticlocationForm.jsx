...
import { saveLogisticlocation, getLogisticlocation } from "../../services/logisticlocationService";

class createLogisticlocation extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveLogisticlocation(this.state.data);
...
export default createLogisticlocation;