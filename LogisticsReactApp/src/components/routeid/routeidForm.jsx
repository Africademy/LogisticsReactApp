...
import { saveRouteid, getRouteid } from "../../services/routeidService";

class createRouteid extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveRouteid(this.state.data);
