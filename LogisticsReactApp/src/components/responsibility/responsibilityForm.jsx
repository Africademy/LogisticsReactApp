...
import { saveResponsibility, getResponsibility } from "../../services/responsibilityService";
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveResponsibility(this.state.data);
