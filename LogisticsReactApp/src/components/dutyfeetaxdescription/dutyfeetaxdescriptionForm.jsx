...
import { saveDutyfeetaxdescription, getDutyfeetaxdescription } from "../../services/dutyfeetaxdescriptionService";

class createDutyfeetaxdescription extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(dutyfeetaxdescriptionId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDutyfeetaxdescription(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Dutyfeetaxdescription Form</h1>
...
export default createDutyfeetaxdescription;