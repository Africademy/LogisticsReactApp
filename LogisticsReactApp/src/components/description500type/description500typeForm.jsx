...
import { saveDescription500type, getDescription500type } from "../../services/description500typeService";

class createDescription500type extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveDescription500type(this.state.data);
    ...
    return (
      <div className="content">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="form-group">
              <label htmlFor="String500Type"> String500 Type</label>
              <input
                value={this.state.data["String500Type"]}
                onChange={this.handleChange}
                name="String500Type"
                id="String500Type"
                type="text"
                className="form-control"
              />
              {this.state.errors["String500Type"] && <div className="alert alert-danger">{this.state.errors["String500Type"]}</div>}
          </div>
...
export default createDescription500type;