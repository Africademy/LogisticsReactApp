...
import { saveTotalloadinglength, getTotalloadinglength } from "../../services/totalloadinglengthService";

class createTotalloadinglength extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTotalloadinglength(this.state.data);
...
export default createTotalloadinglength;