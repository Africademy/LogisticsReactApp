...
import { saveCommunicationchannel, getCommunicationchannel } from "../../services/communicationchannelService";

class createCommunicationchannel extends Component{
...
super(props);
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveCommunicationchannel(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Communicationchannel Form</h1>
...
export default createCommunicationchannel;