...
import { saveLanguageofthepartycode, getLanguageofthepartycode } from "../../services/languageofthepartycodeService";

class createLanguageofthepartycode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(languageofthepartycodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveLanguageofthepartycode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Languageofthepartycode Form</h1>
...
export default createLanguageofthepartycode;