...
import { savePackagingconditioncode, getPackagingconditioncode } from "../../services/packagingconditioncodeService";

class createPackagingconditioncode extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(packagingconditioncodeId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await savePackagingconditioncode(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Packagingconditioncode Form</h1>
...
export default createPackagingconditioncode;