				...
				<div className="py-5">
					...
					<CContainer>
						...
						<CCard>
							...
							<CCollapse show={true}>
								<CCardBody>
									{/* <CInput value={TcbData && TcbData.tvbDta.ServiceDetailsData.servicecategory} onChange={(e)=>e.target.value} /> */}
									...
									>
										{(formik) => (
											<Form>
												<div className="AlertInOrder"></div>
              ...
              <CCardHeader
                ...
                {(
                  <CCollapse  show={true}>
                    ...
                    <CCardBody>
                      <Formik
                        initialValues={initialValuesPickupL}
                        // validationSchema={validationSchema}
                          onSubmit={(values) => {
                          console.log(values);
             ...
             <CCard>
              ...
              <CCardHeader
                ...
                <CCollapse  show={true}>
                     ...
                     <CCardBody>
                      <Formik
                        initialValues={initialValuesDropoffL}
                        // validationSchema={validationSchema}
                          onSubmit={(values) => {
                          console.log(values);
