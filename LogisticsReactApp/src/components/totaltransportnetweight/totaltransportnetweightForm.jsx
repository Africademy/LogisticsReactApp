...
import { saveTotaltransportnetweight, getTotaltransportnetweight } from "../../services/totaltransportnetweightService";

class createTotaltransportnetweight extends Component{
...
super(props);
  ...
  async populateForm() {
    try {
      ...
      if(totaltransportnetweightId!=="new"){
  ...
  handleSubmit = async (event) => {
    ...
    if (errors) return;
    await saveTotaltransportnetweight(this.state.data);
  ...
  render() {
    return (
      <div className="content">
        <h1>Totaltransportnetweight Form</h1>
...
export default createTotaltransportnetweight;